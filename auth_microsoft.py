...
class MicrosoftAuth:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.redirect_uri_prod = auth_config.get("redirect_uri_prod", "https://https://desvios.streamlit.app")
...
def create_login_page(auth: MicrosoftAuth) -> bool:
    ...
    highlights_html = "\n".join([
        ...
        '<strong>Cadastre, edite e visualise desvios!</strong>',
        '<p>Sistema unificado para controle e armazenamentos dos desvios.</p>',
        '</div>',
        '</div>',
        '<div class="highlight-item">',
        '<div class="highlight-icon">🔒</div>',
    ...
    html_parts = [
        ...
        f'{logo_html}',
        '<h1 class="login-title" style="text-align: center; color: black;">CONTROLE DE DESVIOS</h1>',
